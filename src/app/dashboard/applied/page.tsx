...
import { getSourceInfo, formatBudgetGBP, timeAgo, isUKLead } from '@/lib/utils'
...
export default function PipelinePage() {
  ...
  const handleDragStart = (e: React.DragEvent, leadId: string, col: string) => {
    ...
    // Add a slight delay so the browser captures the element before opacity change
    ...
    <div className="flex-1 pb-20 md:pb-0" style={{ background: 'var(--paper)' }}>
      <div className="dash-page">
        <div className="dash-header">
          <div>
            <h1>Pipeline</h1>
            <p style={{ color: 'var(--slate)', fontSize: 14, marginTop: 4 }}>{totalActive} active lead{totalActive !== 1 ? 's' : ''} &middot; drag cards between stages</p>
          </div>
          {wonCount > 0 && (
