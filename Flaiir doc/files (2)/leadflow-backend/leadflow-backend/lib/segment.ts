...
// Copy + behaviour hints the feed uses per segment. Keeping this server-side
// means the messaging can evolve without a client release.
...
> = {
  new: {
    ...
    banner:
      "You're set up. We've scored every open lead against your skills and rate — your strongest matches are crowned at the top.",
  },
  returning: {
  ...
  power: {
    ...
    banner:
      'Power users who apply within 2 hours hear back 3× more often — your freshest matches are up top.',
  },
};
